  ...
  getOptionsFromArgs: (args) => {
    ...
    if (args.length > 0) {
      ...
      if (typeof arg === 'string') {
        ...
        if (params.api_key) {
          opts.headers['APIKEY'] = params.api_key;
        }

        if (params.clover_account) {
          opts.headers['Clover-Account'] = params.clover_account;
        }
        if (params.clover_version) {
          opts.headers['Clover-Version'] = params.clover_version;
        }
      }
    }
    return opts;
...
function emitWarning(warning) {
  ...
  return process.emitWarning(warning, 'Clover');
}
